...
const content = {
  pt: {
    ...
    bio: [
      ...
      'Também mantenho uma base em desenvolvimento de software com Java, HTML, CSS, JavaScript e C, que complementa minha evolução técnica na área de Dados.'
    ],
    education: [
      {
        icon: '🎓',
  ...
  en: {
    ...
    bio: [
      ...
      'I also keep a software development background with Java, HTML, CSS, JavaScript and C, which supports my technical growth in the Data area.'
    ],
    education: [
      {
        icon: '🎓',
