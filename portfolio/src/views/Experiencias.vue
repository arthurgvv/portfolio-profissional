<template>
  <div class="exp-page">
    ...
    <div class="page-header container">
      ...
      <p class="page-subtitle">Minha trajetória acadêmica, profissional e técnica.</p>
    </div>
...
const experiences = [
  ...
  },
  {
    ...
    type: 'Acadêmico',
    description:
      'Graduação em Engenharia de Software com direcionamento para Dados. Estudos focados em SQL, Python, Databricks, modelagem de dados, bancos de dados e fundamentos de desenvolvimento de software.',
