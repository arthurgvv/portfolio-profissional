<template>
  <div class="projects-page">
    ...
    <div class="page-header container">
      ...
      <p class="page-subtitle">Projetos desenvolvidos ao longo da minha trajetória acadêmica e técnica.</p>
    </div>
...
const categories = ['Todos', 'Web App', 'API / Back-end', 'Estudo']
...
const projects = [
  ...
  techs: ['Web App', 'Java', 'JavaScript', 'CSS'],
  category: 'Web App',
  highlight: false,
